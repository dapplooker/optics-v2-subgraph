...
export class celoUSD__fractionMulExpResult {
  value0: BigInt;
  value1: BigInt;
...
export class celoUSD__getInflationParametersResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class celoUSD__getVersionNumberResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class celoUSD extends ethereum.SmartContract {
  static bind(address: Address): celoUSD {
    return new celoUSD("celoUSD", address);
  }
  ...
  fractionMulExp(
    ...
    return new celoUSD__fractionMulExpResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_fractionMulExp(
    ...
    exponent: BigInt,
    _decimals: BigInt
  ): ethereum.CallResult<celoUSD__fractionMulExpResult> {
    let result = super.tryCall(
      "fractionMulExp",
      "fractionMulExp(uint256,uint256,uint256,uint256,uint256,uint256):(uint256,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new celoUSD__fractionMulExpResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getInflationParameters(): celoUSD__getInflationParametersResult {
    let result = super.call(
    ...
    return new celoUSD__getInflationParametersResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_getInflationParameters(): ethereum.CallResult<
    celoUSD__getInflationParametersResult
  > {
    let result = super.tryCall(
      "getInflationParameters",
      "getInflationParameters():(uint256,uint256,uint256,uint256)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new celoUSD__getInflationParametersResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  getVersionNumber(): celoUSD__getVersionNumberResult {
    let result = super.call(
      "getVersionNumber",
    ...
    return new celoUSD__getVersionNumberResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_getVersionNumber(): ethereum.CallResult<celoUSD__getVersionNumberResult> {
    let result = super.tryCall(
      "getVersionNumber",
      "getVersionNumber():(uint256,uint256,uint256,uint256)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new celoUSD__getVersionNumberResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
